...
/**
 * This class represents a Horizontal Flip Command. When executed, this command with call
 * the horizontal flip method of an IPicture mutating the pixels in the array.
 */
public class HorizontalFlip implements Command {
  ...
  /**
   * Creates a new HorizontalFlip command that takes in the current model,
   ...
   */
  public HorizontalFlip(ImageProcessorModel model,
                        IPicture currImage, String returnName) throws IllegalArgumentException {
  ...
  public void execute() {
    ...
    newPicture.horizontalFlip();
    model.addPicture(newPicture, returnName);
  }

  @Override
  public String outputMessage() {
    return "Flipped horizontally and saved as " + returnName + "\n";
  }
}
